...
public class StartHandler {
    ...
    public static boolean handle(MessageReceivedEvent event) {
        ...
        if (!MineMate.getInstance().getDatabaseManager().userExist(uuid)) {
            ...
            description.append(">");
            description.append(" ➔ You have started an adventure, Good Luck. Help : <#"
                    + MineMate.getConfigManager().getString("channels.help") + "> | .h");
            ...
            description.append(user.getId());
            description.append(">");
            description.append(" ➔ You already have started an adventure. Help : <#"
