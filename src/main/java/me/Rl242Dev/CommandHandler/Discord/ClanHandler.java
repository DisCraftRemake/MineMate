...
public class ClanHandler extends ListenerAdapter {
    ...
    public void onMessageReceived(@NotNull MessageReceivedEvent event){
        ...
        if(message.getContentRaw().startsWith(".clan")){
            if(MineMate.debug){
            ...
            if(args.size() < 2){
                ...
                description.append(">");
                description.append(" ➔ .clan [action] [(optional) arg] | <#"+MineMate.getConfigManager().getString("channels.help")+">");
                ...
                if(args.get(1).equals("leave")){
                    if(player.getClan() == null){
                        ...
                        description.append(user.getId());
                        description.append(">");
                        description.append(" ➔ You don't have a Clan | <#"+MineMate.getConfigManager().getString("channels.help")+">");
                ...
                if(args.get(1).equals("kick")){
                    ...
                    if(args.get(2) != null){
                        ...
                        description.append(user.getId());
                        description.append(">");
                        description.append(" ➔ .clan kick [user_id] | <#"+MineMate.getConfigManager().getString("channels.help")+">");
                ...
                if(args.get(1).equals("apply")){
                    if(args.get(2) != null){
                        if(player.getClan() != null){
                            ...
                            description.append(user.getId());
                            description.append(">");
                            description.append(" ➔ You already have a Clan | <#"+MineMate.getConfigManager().getString("channels.help")+">");
                ...
                if(args.get(1).equals("create")){
                    ...
                    if(player.getBalance() < MineMate.getConfigManager().getInt("prices.clan_creation")){
                        ...
                        description.append(user.getId());
                        description.append(">");
                        description.append(" ➔ You don't have enough to afford a Clan | <#"+MineMate.getConfigManager().getString("channels.help")+">");
                    ...
                    MineMate.getInstance().getDatabaseManager().addClanOwner(Utils.IntToString(MineMate.getClans().size()+1), player.getUuid());
