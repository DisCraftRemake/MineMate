...
public class ShopDisplayHandler {
    ...
    public static boolean handle(MessageReceivedEvent event) {
        ...
        if (args.contains("pickaxes") || args.contains("pick")) {
            ...
            Item WoodPickaxe = new Item(Material.WOOD, Type.PICKAXE, "0"); // If Item id = 0, Item is for display
                                                                           // purposes
            ...
            embedBuilder.addField(Emoji.getPickaxeEmoji() + WoodPickaxe.getDisplayName(),
                    ResourceUtils.PriceToString(WoodPickaxe.getSellPrice()) + Coin.getEmojiID(), false);
            embedBuilder.addField(Emoji.getPickaxeEmoji() + StonePickaxe.getDisplayName(),
                    ResourceUtils.PriceToString(StonePickaxe.getSellPrice()) + Coin.getEmojiID(), false);
            embedBuilder.addField(Emoji.getPickaxeEmoji() + IronPickaxe.getDisplayName(),
                    ResourceUtils.PriceToString(IronPickaxe.getSellPrice()) + Coin.getEmojiID(), false);
            embedBuilder.addField(Emoji.getPickaxeEmoji() + GoldPickaxe.getDisplayName(),
                    ResourceUtils.PriceToString(GoldPickaxe.getSellPrice()) + Coin.getEmojiID(), false);
            embedBuilder.addField(Emoji.getPickaxeEmoji() + DiamondPickaxe.getDisplayName(),
                    ResourceUtils.PriceToString(DiamondPickaxe.getSellPrice()) + Coin.getEmojiID(), false);
